...
function setupChat(chat) {
  ...
  addMessage(chat, "أهلا بك في أمان. يمكنك الحديث معي كضيف دون تسجيل. اكتب ما تمر به بكلماتك، وسأحاول توجيهك للمكان المناسب داخل المنصة بالاستناد إلى ذاكرة إرشادية محلية، مع تذكير مهم: هذا توجيه أولي وليس تشخيصا طبيا.");
