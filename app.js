...
function setupChat(chat) {
  ...
  addMessage(chat, "أهلا بك في أمان. يمكنك الحديث معي كضيف دون تسجيل. أعمل بالاستناد إلى ذاكرة إرشادية محددة ومعززة بأبحاث ليبية واقعية، وليست ذاكرة عشوائية أو عامة، لأساعدك في اختيار الخطوة المناسبة داخل المنصة. تذكير مهم: هذا توجيه أولي وليس تشخيصا طبيا ولا يغني عن المختص.");
